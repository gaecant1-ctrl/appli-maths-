...
function u(a, b) {
    ...
    var c = /^step([A-Z]\w*)$/, d, e;
    for (e in this)
        "function" === typeof this[e] && (d = e.match(c)) && (this.nb[d[1]] = this[e].bind(this));
    this.global = ia(this, this.ha, null);
    this.ha = acorn.parse(this.V.join("\n"), ha);
    this.V = void 0;
    ra(this, this.ha, void 0, void 0);
    c = new y(this.ha,this.global);
    c.done = !1;
    this.j = [c];
    this.lb();
    this.value = void 0;
    ...
    var e = function(g) {
        ...
        if (v) {
            ...
            for (var D = 0; D < v.length; D++) {
                var B = v[D];
                d.test(B) || J(a, a.fa, "Invalid function argument: " + B)
            }
            v = v.join(", ")
        }
        l.ca = a.global;
        try {
            var ca = acorn.parse("(function(" + v + ") {" + q + "})", ha)
        } catch (na) {
            J(a, a.fa, "Invalid code: " + na.message)
        }
        1 !== ca.body.length && J(a, a.fa, "Invalid code in function body.");
...
function cb(a, b) {
    function c(e) {
        void 0 !== e && null !== e || J(a, a.h, "Cannot convert '" + e + "' to object")
    }
    var d = function(e) {
        if (void 0 === e || null === e)
    ...
    d = function(e) {
        if (null === e)
            return a.g(null);
        void 0 !== e && e.o || J(a, a.h, "Object prototype may only be an Object or null");
        return a.g(e)
    }
    ;
    ...
    d = function(e, g, l) {
        g = String(g);
        e && e.o || J(a, a.h, "Object.defineProperty called on non-object");
        l && l.o || J(a, a.h, "Property description must be an object");
        !e.a[g] && e.preventExtensions && J(a, a.h, "Can't define property '" + g + "', object is not extensible");
    ...
    d = function(e, g) {
        e && e.o || J(a, a.h, "Object.getOwnPropertyDescriptor called on non-object");
        g = String(g);
        if (g in e.a) {
...
function db(a, b) {
    var c = function(d) {
        var e = vc(a) ? this : a.g(a.ea)
          , g = arguments[0];
        if (1 === arguments.length && "number" === typeof g)
            isNaN(wc(g)) && J(a, a.Ya, "Invalid array length"),
            e.a.length = g;
        else {
    ...
    M(a, a.l, "join", c);
    c = function(d) {
        for (var e = [], g = 0, l = a.v(this, "length"), q = 0; q < l; q++) {
            if (xc(a, this, q)) {
                var v = a.v(this, q);
                e[g] = v
            }
...
function Eb(a, b) {
    ...
    for (var d = 0; d < c.length; d++)
        M(a, a.A, c[d], String.prototype[c[d]]);
    c = function(e, g, l) {
        g = g ? a.M(g) : void 0;
        l = l ? a.M(l) : void 0;
    ...
    c = function(e, g, l) {
        var q = String(this);
        g = g ? Number(g) : void 0;
        if (T(a, e, a.D) && (e = e.data,
        yc(a, e, l),
        2 === a.REGEXP_MODE)) {
            if (Ka)
                e = zc(a, "string.split(separator, limit)", {
                    string: q,
                    separator: e,
                    limit: g
                }, e, l),
    ...
    c = function(e, g, l) {
        ...
        2 === a.REGEXP_MODE)) {
            if (Ka)
                e = zc(a, "string.replace(substr, newSubstr)", {
                    string: q,
                    substr: e,
                    newSubstr: g
                }, e, l),
...
function Hb(a, b) {
    var c = function(g, l) {
        if (!vc(a))
            return Date();
        var q = [null].concat(Array.from(arguments));
        this.data = new (Function.prototype.bind.apply(Date, q));
        return this
    };
    a.S = a.b(c, !0);
        ...
        c = function(g) {
            return function(l) {
                for (var q = [], v = 0; v < arguments.length; v++)
                    q[v] = a.M(arguments[v]);
                return this.data[g].apply(this.data, q)
            }
        }(d[e]),
        M(a, a.S, d[e], c)
}
    ...
    c = function(d, e) {
        ...
        if (2 === a.REGEXP_MODE)
            if (Ka) {
                ...
                v !== Ia && (a.setProperty(l, "lastIndex", q.lastIndex),
                e(g(v)))
            } else {
                v = a.X();
                var D = Qc(a, q, v, e);
                ...
                ;
                v.postMessage(["exec", q, q.lastIndex, d])
            }
        else
            v = q.exec(d),
            a.setProperty(l, "lastIndex", q.lastIndex),
            e(g(v))
    }
    ;
    Rc(a, a.D, "exec", c)
...
function Jb(a, b) {
    function c(d) {
        var e = a.b(function(g) {
            var l = vc(a) ? this : a.pa(e);
            g && a.setProperty(l, "message", String(g), A);
            return l
        }, !0);
        a.setProperty(e, "prototype", a.pa(a.w), A);
        a.setProperty(e.a.prototype, "name", d, A);
        a.setProperty(b, d, e);
        return e
    }
    a.w = a.b(function(d) {
        var e = vc(a) ? this : a.pa(a.w);
...
p.la = function(a) {
    ...
    if (a instanceof Function) {
        ...
        return this.b(function() {
            return c.la(a.apply(c, Array.prototype.slice.call(arguments).map(function(e) {
                return c.M(e)
            })))
        }, void 0)
    }
...
;
function P(a, b) {
    for (var c = a.g(a.ea), d = Object.getOwnPropertyNames(b), e = 0; e < d.length; e++)
    ...
    if (a.o) {
        if (T(this, a, this.A)) {
            ...
            if ("length" === b || !isNaN(g) && g < String(a).length) {
                e && J(this, this.h, "Cannot assign to read only property '" + b + "' of String '" + a.data + "'");
                return
            }
        }
        if ("Array" === a.K)
            ...
            "length" === b) {
                ...
                isNaN(l = Tc(b)) || (a.a.length = Math.max(g, l + 1));
        if (!a.preventExtensions || b in a.a)
            if (d) {
                ...
                if (d.R && d.R[b])
                    return d.R[b];
                if (d.O && d.O[b])
                    e && J(this, this.h, "Cannot set property '" + b + "' of object '" + a + "' which only has a getter");
                else
                    try {
                        a.a[b] = c
                    } catch (q) {
                        e && J(this, this.h, "Cannot assign to read only property '" + b + "' of object '" + a + "'")
                    }
            }
        else
            e && J(this, this.h, "Can't add property '" + b + "', object is not extensible")
    } else
        e && J(this, this.h, "Can't create property '" + b + "' on '" + a + "'")
}
;
function M(a, b, c, d) {
...
function $c(a, b, c, d) {
    ...
    a: for (; 0 < e.length; e.pop()) {
        ...
        if (1 === b) {
            if (d ? g.labels && -1 !== g.labels.indexOf(d) : g.P || g.Hb) {
                e.pop();
                return
            }
        } else if (2 === b && (d ? g.labels && -1 !== g.labels.indexOf(d) : g.P))
            return
    }
    T(a, c, a.w) ? (b = {
        EvalError: EvalError,
...
u.prototype.stepObjectExpression = function(a, b, c) {
    ...
    if (e)
        return new y(e.value,b.scope);
    for (g in b.za)
        c = b.za[g],
        "get"in c || "set"in c ? this.setProperty(b.i, g, Ha, {
            configurable: !0,
            enumerable: !0,
            get: c.get,
            set: c.set
    ...
    if ("-" === c.operator)
        ...
        if (Array.isArray(d)) {
            ...
            try {
                ...
                b.scope.H ? J(this, this.h, "Cannot delete property '" + d + "' of '" + e + "'") : c = !1
            }
        }
        d = c
...
u.prototype.stepVariableDeclaration = function(a, b, c) {
    ...
    var d = b.s || 0
      , e = c[d];
    b.jb && e && (Xc(this, e.id.name, b.value),
    b.jb = !1,
    e = c[++d]);
    for (; e; ) {
        if (e.init)
